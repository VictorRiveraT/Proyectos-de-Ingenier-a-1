...
- El cableado se canaliza internamente por un ducto central para evitar interferencias con el campo eléctrico del sensor capacitivo.  
- El contenedor transparente está pensado en acrílico líquido, que soporta temperaturas moderadas y permite la correcta lectura óptica del aceite.
...
- Validar la disposición interna de los componentes antes de la impresión 3D.  
- Determinar el volumen disponible para los sensores y cableado.  
- Analizar la estabilidad del prototipo y su centro de gravedad.  
- Evaluar posibles interferencias térmicas y ópticas entre los sensores.  

### Próximos pasos
El siguiente paso será ajustar el diseño con base en el espesor real de las paredes imprimibles, los soportes de los sensores y la tapa del recipiente de aceite.  
Posteriormente se realizará la **impresión 3D en PETG o ABS**, materiales disponibles en el laboratorio, y se llevará a cabo el ensamblaje de prueba para verificar la alineación óptica y eléctrica del sistema.
