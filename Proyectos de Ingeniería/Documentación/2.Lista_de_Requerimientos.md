...
| 09/09/25 | E    | Funcion secundaria | El dispositivo debe mostrar el nivel de calidad de aceite( Apto/ No apto ) mediante un indicador visual y/o pantalla LCD de forma clara y legible.                                                      | Vanesa R, Victor R             |
...
| 18/08/25 | E    | Geometría y portabilidad | Prototipo compacto y liviano (<1.5 kg). Dimensiones: alto: 23 cm, largo: 21 cm, ancho 11.5 cm diseñado para transporte en mochila y uso en campo (ISO 7250).                                                                                                                         | Victor R                   |
